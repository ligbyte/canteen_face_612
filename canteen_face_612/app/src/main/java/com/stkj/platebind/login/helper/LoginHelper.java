package com.stkj.platebind.login.helper;
...
import com.stkj.platebind.login.ui.fragment.LoginAlertFragment;
...
//                                  AndroidUtils.restartApp();
    ...
    private void addMainLoginPlaceFragment(MainActivity activity, Fragment fragment) {
        FragmentUtils.safeAddFragment(activity.getSupportFragmentManager(), fragment, com.stkj.platebind.R.id.fl_login_placeholder);
    }
