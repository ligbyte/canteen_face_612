...
import com.stkj.platebind.base.callback.SimpleSeekBarChangeListener;
...
public class CommonSeekProgressBar extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            TypedArray array = context.obtainStyledAttributes(attributeSet, com.stkj.platebind.R.styleable.CommonSeekProgressBar);
